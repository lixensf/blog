...
<ul class="breadcrumb">
    <li>
        ...
        <a href="{{route('admin.index')}}">{{$parent}}</a></li>
    <svg class="bi bi-file-post" width="1.2em" height="1.7em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
